!function () {
    ...
    function m(b) {
        var f,
            ...
            e,
            c = new DataView(b)
        if ((a && console.log("Got file of length " + b.byteLength), 255 != c.getUint8(0) || 216 != c.getUint8(1)))
            return a && console.log("Not a valid JPEG"), !1
        for (d = 2, e = b.byteLength; e > d; ) {
            if (255 != c.getUint8(d))
                return a && console.log("Not a valid marker at offset " + d + ", found: " + c.getUint8(d)), !1
            if (((f = c.getUint8(d + 1)), a && console.log(f), 225 == f))
                return a && console.log("Found 0xFFE1 marker"), u(c, d + 4, c.getUint16(d + 2) - 2)
            d += 2 + c.getUint16(d + 2)
        }
    }
    function o(b) {
    ...
    function u(b, c) {
        ...
        if (((n = b.getUint32(m + 4, !h)), 8 > n))
            return a && console.log("Not valid TIFF data! (First offset less than 8)", b.getUint32(m + 4, !h)), !1
    ...
    "undefined" != typeof exports
        ? ("undefined" != typeof module && module.exports && (exports = module.exports = c), (exports.EXIF = c))
        : (b.EXIF = c),
        (d = c.Tags =
            {
                36864: "ExifVersion",
        ...
        (c.getData = function (a, b) {
            return (a instanceof Image || a instanceof HTMLImageElement) && !a.complete
                ? !1
                    ...
                    (d +=
                        "object" == typeof c[b]
                            ? c[b] instanceof Number
                                ? b + " : " + c[b] + " [" + c[b].numerator + "/" + c[b].denominator + "]\r\n"
                                : b + " : [" + c[b].length + " values]\r\n"
                            : b + " : " + c[b] + "\r\n")
            return d
        }),
